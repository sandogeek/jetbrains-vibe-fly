        ...
        return (
            <div
                ...
                className={cn(
                    ...
                    "group-data-[variant=muted]/reasoning-root:bg-[linear-gradient(to_bottom,color-mix(in_srgb,var(--color-muted)_50%,var(--color-background)),transparent)]",
    ...
    return (
        <div
            ...
            className={cn(
                ...
                "group-data-[variant=muted]/reasoning-root:bg-[linear-gradient(to_top,color-mix(in_srgb,var(--color-muted)_50%,var(--color-background)),transparent)]",
                "fade-in-0 animate-in",
                "animation-duration-(--animation-duration)",
                className,
            )}
...
export function ReasoningText({
    ...
    useEffect(() => {
        ...
        const isAtBottom = () =>
            ...
            ) <= 1 || scrollElement.scrollHeight <= scrollElement.clientHeight

        const pinToNewestTokens = () => {
            if (!pinned) return
        ...
        const observer = new ResizeObserver(pinToNewestTokens)
