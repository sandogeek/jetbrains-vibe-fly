    ...
    return (
        <ContextMenuPrimitive.SubTrigger
            ...
            className={cn(
                ...
                "focus:bg-surface focus:text-fg data-[state=open]:bg-surface data-[state=open]:text-fg",
    ...
    return (
        <ContextMenuPrimitive.Portal>
            <ContextMenuPrimitive.Content
                ...
                className={cn(
                    "z-50 max-h-(--radix-context-menu-content-available-height) min-w-[8rem] overflow-x-hidden overflow-y-auto",
                    "rounded-md border border-border bg-surface p-1 text-fg shadow-md",
                    className,
                )}
                {...props}
            />
...
function ContextMenuLabel({
    ...
    return (
        <ContextMenuPrimitive.Label
            ...
            data-inset={inset}
            className={cn("px-2 py-1.5 text-sm font-semibold text-fg data-[inset]:pl-8", className)}
            {...props}
        />
    )
}
