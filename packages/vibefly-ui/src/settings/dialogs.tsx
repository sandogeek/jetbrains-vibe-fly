...
export function providerUiLabels(t: Translator): ProviderUiLabels {
    return {
        ...
        rowLoginOrApiKey: t("providers:rowLoginOrApiKey"),
        rowApiKeyRequired: t("providers:rowApiKeyRequired"),
        rowApiKeySet: t("providers:rowApiKeySet"),
        rowOauthSignedIn: t("providers:rowOauthSignedIn"),
        rowCustomModelCount: (count) => t("providers:rowCustomModelCount", {count}),
